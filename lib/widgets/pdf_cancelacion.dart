...
// Función principal para generar PDF de cancelación
Future<void> generarPdfCancelacion({
  required String tipoMovimiento, // 'ENTRADA' o 'SALIDA'
          ...
          children: [
            ...
            pw.Column(
              ...
              children: [
                ...
                pw.Container(
                  ...
                  child: pw.Text(
                    'MOVIMIENTO DE INVENTARIOS: $tituloMovimiento',
                    style: pw.TextStyle(
                      fontSize: 12,
                      fontWeight: pw.FontWeight.bold,
                    ),
            ...
            pw.Positioned(
              ...
              child: pw.Row(
                ...
                children: [
                  // Firma de quien cancela/devuelve
                  pw.Column(children: [
                    pw.Container(
                      width: 120,
                      height: 1,
  ...
  try {
    ...
    final String fileName =
        '${tipoMovimiento}_Cancelacion_${currentDate}_$currentTime.pdf';
    ...
    print('PDF de cancelación generado exitosamente.');
  } catch (e) {
