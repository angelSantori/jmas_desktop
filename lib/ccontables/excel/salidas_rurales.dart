...
class ExcelSalidasRurales {
  static Future<void> generateExcelSalidasRurales({
    ...
    try {
      ...
      final concepto =
          'SALIDAS DE JUNTAS RURALES DEL 01/${selectedMonth.toString().padLeft(2, '0')} AL ${lastDay.day.toString().padLeft(2, '0')}/${selectedMonth.toString().padLeft(2, '0')} DE ${getMonthName(selectedMonth).toUpperCase()} $currentYear';
      ...
      final String fileName =
          'Poliza_Salidas_Juntas_Rurales_${selectedMonth}_${DateTime.now().year}_${DateFormat('ddMMyyyy_HHmmss').format(DateTime.now())}.xlsx';
