...
class ExcelEntradasEspeciales {
  static Future<void> generateExcelEntradasEspeciales({
    ...
    try {
      ...
      final concepto =
          'ENTRADAS CONSOLIDADAS DE JUNTAS ESPECIALES DEL 01/${selectedMonth.toString().padLeft(2, '0')} AL ${lastDay.day.toString().padLeft(2, '0')}/${selectedMonth.toString().padLeft(2, '0')} DE ${getMonthName(selectedMonth).toUpperCase()} $currentYear';
      ...
      final String fileName =
          'Poliza_Entradas_Juntas_Especiales_${selectedMonth}_${DateTime.now().year}_${DateFormat('ddMMyyyy_HHmmss').format(DateTime.now())}.xlsx';
      ...
      print('Errror al generateExcelEntradasEspeciales | Try: $e');
    }
  }
}
