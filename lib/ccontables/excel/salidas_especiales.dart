  ...
  static Future<void> generateExcelSalidasEspeciales({
    ...
    try {
      ...
      final salidasInPeriod = allSalidas.where((s) {
        if (s.salida_Fecha == null || s.id_Junta == null) {
          return false;
        }
      ...
      // Agrupar salidas por producto (sin importar la junta) - solo para la hoja contable
      ...
      // Hoja 1: Reporte Salidas Especiales (formato contable)
      final Worksheet sheet1 = workbook.worksheets[0];
      sheet1.name = 'Reporte Salidas Especiales';

      // Hoja 2: Salidas Especiales Activas
      final Worksheet sheet2 = workbook.worksheets.add();
      sheet2.name = 'Salidas Especiales Activas';

      // Hoja 3: Salidas Especiales Completas
      final Worksheet sheet3 = workbook.worksheets.add();
      sheet3.name = 'Salidas Especiales Completas';

      // ===== HOJA 1: Reporte Salidas Especiales =====
